...
Public Class Form1
    Dim IMG As Image
    Dim con As SqlConnection = New SqlConnection("Data Source=DESKTOP-AU1HOJT\SQLEXPRESS;Initial Catalog=CBSE;Integrated Security=True")
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        For j = 0 To cntr - 1
            ...
            doc.Open()
            IMG = Image.GetInstance("E:\THEORY_OBSERVER_2021\THEORY_OBSERVER_2021\IMG\HEADER.PNG")
            IMG.ScaleToFit(525.0F, 200.0F)
            IMG.SetAbsolutePosition(15, 750)
            doc.Add(IMG)
            IMG = Image.GetInstance("E:\THEORY_OBSERVER_2021\THEORY_OBSERVER_2021\IMG\FOOTER.PNG")
            IMG.ScaleToFit(525.0F, 200.0F)
...
YOURS FAITHFULLY")
            ...
            doc.Add(p17)
            IMG = Image.GetInstance("E:\THEORY_OBSERVER_2021\THEORY_OBSERVER_2021\IMG\rosignpng.PNG")
...
Encl: As above.")
            ...
            doc.Add(p19)
            doc.NewPage()
            IMG = Image.GetInstance("E:\THEORY_OBSERVER_2021\THEORY_OBSERVER_2021\IMG\acceptance_header.PNG")
            IMG.ScaleToFit(525.0F, 200.0F)
            IMG.SetAbsolutePosition(15, 750)
            doc.Add(IMG)
            IMG = Image.GetInstance("E:\THEORY_OBSERVER_2021\THEORY_OBSERVER_2021\IMG\FOOTER.PNG")
